                           ...
                           <form method="post" action="{{ route('logos.update',$logo->id) }}" id="myForm" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-5" style="padding-top: 10px;">
                                    <img id="showImage" src="{{!empty($logo->image)?url('/school/public/upload/logo_image/'.$logo->image):url('/upload/no_image.jpg')}}" height="150px" width="130px;"  style="border: 1px solid #000;" alt="Card image cap"/>
                                </div>
