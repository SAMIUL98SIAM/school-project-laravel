        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Subject List</h3>
                    <button class="btn btn-success float-right btn-sm" data-toggle="modal" data-target="#basicModal"><i class="fa fa-plus-circle"> Add Subject</i></button>
                    <!--Create Modal--->
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ route('setups.subject.store') }}" id="myForm">
                                        ...
                                        <div class="form-group">
                                            <label class="name">Subject Name</label>
                                    ...
                                    <div style="color: #000" class="modal fade" id="editModal{{ $key }}">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ route('setups.subject.update',$subject->id) }}">
                                                        @csrf
                                                        @method('PUT')
