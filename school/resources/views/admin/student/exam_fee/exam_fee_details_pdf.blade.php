    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <h5 style="font-weight: bold;padding-top:-25px">Student Exam Fee Payslip(Student Copy)</h5>
            </div>
            <div class="col-md-12">
                @php
                    $registrationfee =
                    App\Models\FeeCategoryAmount::where('fee_category_id','3')->where('class_id',$details->class_id)->first();
