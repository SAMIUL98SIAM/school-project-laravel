                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="40%" class="text-center">
                                <p style="color:red;font-size:20px;margin-bottom:5px !important;"><strong>Milestone School</strong></p><br/>
                            ...
                            <td width="30%" class="text-right" style="padding: 10px;">
                                <img src="{{ (!empty($data['student']['image'])) ?url('/school/public/upload/student_image/'.$data['student']['image']):url('/upload/no_image.jpg')}}" style="width: 63px;height:73px; border-radius:5px;" alt="">
                            </td>
                        </tr>
