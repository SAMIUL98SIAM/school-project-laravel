        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Attendence List</h3>
                ...
                <form method="post" action="{{route('employees.attendence.store')}}" id="myForm">
                    ...
                    <div class="card-body">
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" id="date" name="date" class="checkdate form-control form-control-sm">
                        </div>
                                    ...
                                    <tr id="div{{$employee->id}}" class="text-center">
                                        ...
                                        <td colspan="3">
                                            <div class="switch-toggle switch-3 switch-candy">
                                                ...
                                                <input class="absent" id="absent{{$key}}" name="attend_status{{$key}}" value="Absent" type="radio"  checked="checked"/>
                                                <label for="absent{{$key}}">Absent</label>

                                                <input class="leave" id="leave{{$key}}" name="attend_status{{$key}}" value="Leave" type="radio"  checked="checked"/>
